  ...
  <div class="backImage color-b" id="intro">
    <v-row>
      <v-col cols="12" sm="4" md="4" class="pa-10 hidden-xs-only">
        <v-img src="../assets/iphone_mockup.png" class="pl-8" max-width="700px"></v-img>
      </v-col>
      <v-col cols="12" sm="8" class="pa-10" md="8">
        <v-row align="end">
          ...
          <v-col cols="12" class="hidden-sm-and-down">
            ...
            >Nexd verbindet Hilfesuchende und Freiwillige aus der Umgebung –Schnell und unkompliziert.</div>
          </v-col>
          ...
          <v-col cols="12" style="height:20vh" class="hidden-sm-and-down"></v-col>
          <v-col cols="12">
            <v-row>
              <v-col
                cols="12"
    ...
    <v-row class="px-8 pb-8" align="center">
      <v-col cols="12" sm="6" md="4" class="hidden-sm-and-down">
        <div>
          <div id="square" class="pa-10 headline" style="font-weight:400; color:#fff">
            Melde dich jetzt als Tester an und sei einer der ersten Nutzer.
            <div
              @click="$vuetify.goTo('#footer', options)"
              style="width:80%;background:#0C2E45; border-radius: 4px; color:#fff; cursor:pointer; text-align:center"
              class="mt-3 pa-2"
              block
      ...
      <v-col class="my-auto">
        <v-row style="text-align: right;" class="hidden-sm-and-down">
          <v-col cols="12" class="headline decor pb-4" style="font-weight: 400;">
          ...
          <v-col class="body-1 font-weight-regular">
            ...
            per App oder die Hotline
            <br />(0721-98419016).
            <br />
            <br />Egal ob nur ein Lebensmittel oder ein gesamter
            Einkauf, freiwillige Helferinnen und Helfer sehen alle
            Aufträge in ihrer Nachbarschaft auf Nexd und
            erledigen sie schnell und zuverlässig.
          </v-col>
        </v-row>
